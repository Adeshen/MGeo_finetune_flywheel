...
if __name__ == "__main__":
    input_file = "alibaba_opensource_data/bio_token/alibaba_tokens.jsonl"
    output_file = "alibaba_opensource_data/format_entity_data/alibaba_formatted_entity.jsonl"

    convert_inference_results(input_file, output_file, 'detailed')
